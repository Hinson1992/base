...
public class Gys_update extends JDialog {
		...
		}
		{
			...
			btnNewButton.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					if (UserService.gysUpdate(gysinfo)) {
						JOptionPane.showMessageDialog(Gys_update.this, "修改成功!");
						...
						Gys_update.this.setVisible(false);
						Gys_update.this.dispose();
					} else {
						JOptionPane.showMessageDialog(Gys_update.this, "修改失败!");
					}
