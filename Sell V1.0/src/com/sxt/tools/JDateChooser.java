...
public class JDateChooser extends JPanel {
	...
	public JDateChooser(Container owner, int length) {
		this.owner = owner;
	...
	public JDateChooser(Container owner, String partten, int length) {
		this.owner = owner;
		this.parten = partten;
		this.length = length;
		try {
	...
	public JDateChooser(Container owner, String partten) {
		this.owner = owner;
		this.parten = partten;
		try {
			init();
	...
	public JDateChooser(Container owner) {
		this.owner = owner;
		this.parten = "yyyy-MM-dd";
		try {
			init();
	...
	private void init() throws Exception {
		...
		btnChoose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JDateChooser.this.btnChoose_actionPerformed(e);
			}
		});
		Date date = new Date();
		...
		public void mouseClicked(MouseEvent e) {
			if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1) {
				...
				SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
						pattern);
				JDateChooser.this.setText(simpleDateFormat.format(selectDate));
